        ...
        <div class="navbar-header">
            ...
            <span>
                <a href="<?= View::genPathSite('') ?>">
                    <img id="logoPortada" src="<?php echo get_stylesheet_directory_uri() ?>/images/logo1.png"
                         alt="Cuba, por favor">
                </a>
            </span>
        </div>
...
<section id="main-slider">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div>
                                        ...
                                        <p class="carrusel-texto-corto hidden-xs"><?= __($imagenPortada->textoCorto) ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--    Acordion de la busqueda-->
    <div class="panel-group visible-xs" id="accordionSearch">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a id="desplegarBusqueda" class="accordion-toggle" data-toggle="collapse"
                       data-parent="#accordionSearch" href="#collapseSearch">
                        <h3><span><?= __(L_ENCUENTRELO_ACORDION) ?></span><em class="fa fa-angle-double-down"></em></h3>
                    </a>
                </h4>
            </div>
                ...
                <div class="panel-body">
                    <div class="findbox">
                        <form id="form_search" role="form" action="<?= View::genPathSite('search') ?>">
                            <label class="label label-warning col-xs-12 col-sm-12 col-md-12"
                                   style="margin: 0"><?= __(CS_L_BUSCAR) ?></label>
                            <input class="form-control" value="<?= View::in('find_q', '') ?>" name="find_q"
                                   placeholder="<?= __(CS_L_PLACEHOLDER) ?>">

                            <div class="btn-group">
                                <label class="label label-warning col-xs-4 col-sm-4 col-md-4"
                                       style="margin: 0"><?= __(CS_L_TIPO) ?></label>
                        ...
                        <div
                            class="btn-group col-md-10 col-xs-12 col-sm-10 col-md-offset-1 col-sm-offset-2 col-xs-offset-0">
                            <button type="submit" onclick="jQuery('#form_search').submit()"
                                    class="btn btn-danger col-xs-10 col-sm-12 col-md-12">
    ...
    <div class="col-sm-4 col-md-3 column-slider hidden-xs">
