...
<div class="container-fluid no-padding">
    ...
    <div class="row-fluid">
        <div class="col-xs-12 col-md-5 right-hr hidden-xs hidden-sm">
            <h3><em class="fa fa-calendar"></em> <?= __(CS_L_PROGRAMA) ?></h3>
        ...
        <div class="col-xs-12 col-md-7 col-sm-12">
            <div id="carousel-example-generic" class="carousel slide col-sm-6 col-md-12" data-slide="next">
            ...
            <div class="col-sm-6 col-md-12">
                <h4 class="hidden-xs"><?= __(CS_L_DESC) ?></h4>

                <div class="hidden-xs" style="text-align: justify">
            ...
            <div class="col-sm-12 visible-sm">
                <ul id="tabBook" class="nav nav-tabs">
        ...
        <div class="panel-group-reserva visible-xs" id="accordion-reserva">
            ...
            <div class="panel panel-reserva">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a id="popularidadAcordion" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-reserva"
                           href="#collapsePopReserva">
                            <h3><?= __(CS_L_POPULARIDAD) ?> <em class="fa fa-angle-double-down"></em></h3>
                        </a>
                    </h4>
                </div>
                <div id="collapsePopReserva" class="panel-collapse collapse">
                    <div class="panel-body">
                        <h4>5 <span class="fa fa-star"></span></h4>
        ...
        <div class="row-fluid">
            ...
            <div class="bookbox col-xs-12 col-sm-6 col-md-6 no-padding">
                <form class="validateEngine" id="form_book2" role="form"
                      action="<?= View::genPathSite('book-page?id=' . View::in('id')) ?>">
                    <input type="hidden" name="tokenForm2" value="<?= wp_get_session_token(); ?>">
                    <label class="label-book col-xs-12 col-sm-12 col-md-12"
            ...
            <div class="bookbox col-xs-12 col-sm-12 col-md-12 no-padding">
                <form class="validateEngine" id="form_book3" role="form"
                    ...
                    <input type="hidden" name="tokenForm3" value="<?= wp_get_session_token(); ?>">
