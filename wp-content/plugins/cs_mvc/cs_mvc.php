...
function cs_mvc_scripts() {
    ...
    if(is_admin()) {
        ...
        wp_enqueue_style( 'jquery-validate-css', plugins_url('assetic/libs/jquery-Validation/css/validationEngine.jquery.css',__FILE__),array(),'1.6',true);
        wp_enqueue_script( 'jquery-validate-script', plugins_url('assetic/libs/jquery-Validation/js/jquery.validationEngine.js',__FILE__),array(),'1.6',true);
//        wp_enqueue_script( 'jquery-validate-script_lang', plugins_url('assetic/libs/jquery-Validation/js/languages/jquery.validationEngine-en.js',__FILE__),array(),'1.6',true);
        wp_enqueue_script( 'jquery-validate-script_lang', plugins_url('assetic/libs/jquery-Validation/js/languages/jquery.validationEngine-'. $q_config['language'].'.js',__FILE__),array(),'1.6',true);
