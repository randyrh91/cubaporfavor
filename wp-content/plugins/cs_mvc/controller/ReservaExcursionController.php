...
//        $this->redirect($this->genPathSite('book-page') . '?id=' . $_REQUEST['id'].'&r=1#form_reserva');
    ...
    function saveJSON()
    {
        ...
        if (isset($_REQUEST['tokenForm1']) && isset($_REQUEST['tokenForm2']) && isset($_REQUEST['tokenForm1'])) {
            if ($_REQUEST['tokenForm1']==$token && $_REQUEST['tokenForm2']==$token && $_REQUEST['tokenForm3']==$token) {
                ...
                $html =
                    '<h2>Reserva desde el Sitio cubaporfavor.com contactar de inmediato!</h2><br>' .
